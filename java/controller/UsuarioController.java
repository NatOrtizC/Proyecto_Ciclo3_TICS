...
@Override
    ...
    @Override
    public String verVolumen(String username) {

        DBConnection con = new DBConnection();
        String sql = "Select id,count(*) as num_volumen from registro where username = '"
        ...
        try {
            ...
            while (rs.next()) {
                int id = rs.getInt("id");
                int num_volumen= rs.getInt("num_volumen");

                copias.put(id, num_volumen);
            }

            devolverProducto(username, copias);
    ...
    public String devolverProducto(String username, Map<Integer, Integer> copias) {
        ...
        try {
            for (Map.Entry<Integer, Integer> producto : copias.entrySet()) {
                int id = producto.getKey();
                int num_volumen = producto.getValue();

                String sql = "Update producto set copias = (Select copias + " + num_volumen
    ...
    public String eliminar(String username) {
        ...
        String sql1 = "Delete from registro where username = '" + username + "'";
